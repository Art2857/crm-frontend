  ...
  return (
    <div className="space-y-4">
      <h4 className="text-lg font-medium text-gray-900">
        Разбивка по периодам изменения{' '}
        {isCompact ? 'обязанности' : 'обязанностей'}:
      </h4>
              ...
              {period.duties.map((duty) => (
                ...
                >
                  ...
                  <span className="font-mono">
                    {formatCurrency(duty.monthlyAmount)} × {period.days}/
                    {period.monthDays} = {formatCurrency(duty.calculatedAmount)}
                  </span>
                </div>
              ))}
