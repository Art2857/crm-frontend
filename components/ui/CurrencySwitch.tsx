...
export default function CurrencySwitch({ value, onChange, size = 'md', className = '' }: CurrencySwitchProps) {
  const isUSD = value === 'USD';

  const containerBase = 'inline-flex items-stretch rounded-md border bg-white overflow-hidden select-none';
