...
export const useErrorHandler = (
   ...
   */
  const extractErrorMessage = useCallback((error: unknown, errorType: ErrorType): string => {
   ...
   */
  const displayError = useCallback((structuredError: StructuredError): void => {
   ...
   */
  const handleError = useCallback((error: unknown): StructuredError => {
